...
import org.example.quizservice.repository.ExamSubmissionRepository;
...
public class ExamService {
    ...
    public ResponseEntity<ResultDTO> getAvailableExamsByCourseId(Long courseId, String validateUserId) {
        ResultDTO resultDTO = new ResultDTO();

        if (!validateIsInCourse(courseId, validateUserId)) {
            resultDTO.setStatus(0);
            resultDTO.setMessage("You don't have permission to view exams for this course");
            return new ResponseEntity<>(resultDTO, HttpStatus.FORBIDDEN);
        }
        ...
        for (ExamEntity exam : exams) {
            ...
            exam.setNumberQuestions(null);
            exam.setShuffleAnswers(null);
            exam.setShuffleQuestions(null);
            exam.setSubmissions(null);
        }
    ...
    public ResponseEntity<ResultDTO> updateExam(Long examId, ExamDTO examDTO, String validateUserId) {
        ...
        existingExam.setNumberSubmission(examDTO.getNumberSubmission());
    ...
    public Boolean fallbackValidate(Long courseId, String userId, Throwable t) {
        throw new RuntimeException("Connect course service failed", t);
    }
}
